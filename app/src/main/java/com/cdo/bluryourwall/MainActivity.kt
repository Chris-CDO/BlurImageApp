...
class MainActivity : AppCompatActivity() {
    ...
    private val imagePickerLauncher = registerForActivityResult(
        ...
        uri?.let {
            ...
            seekBar.progress = 0
            blurPercentageText.text = "Blur: 0%"
            toggleControls(true)
    ...
    private fun resizeBitmapIfNeeded(bitmap: Bitmap, maxSize: Int = 1920): Bitmap {
    ...
    private fun applyAndShowBlur(radius: Int) {
        CoroutineScope(Dispatchers.IO).launch {
            try {
                ...
                } ?: throw Exception("The image could not be decoded.")

                val resizedBitmap = resizeBitmapIfNeeded(originalBitmap, 1920)
